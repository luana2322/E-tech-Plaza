...
public class CustomerServiceImpl implements CustomerService {
	...
	@Override
	public Customer save(CustomerDto customerDto, String siteURL)
		...
		customer.setVerificationCode(customerDto.getCode());
		customer.set_email_verified(true);
	...
	@Override
	public void sendVerificationEmail(Customer customer, String siteURL, HttpSession section)
			throws MessagingException, UnsupportedEncodingException {

		String randomCode = RandomStringGenerator.randomString(64);
		customer.setVerificationCode(randomCode);

		section.setAttribute("code", randomCode);
		...
		content = content.replace("[[code]]", customer.getVerificationCode());
